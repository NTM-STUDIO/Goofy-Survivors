...
public partial struct CollisionDamageSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        var job = new TriggerDamageJob
        {
            ...
            ProjectileDataLookup = SystemAPI.GetComponentLookup<ProjectileData>(true), // ReadOnly is fine if we don't modify PierceCount yet
    ...
    struct TriggerDamageJob : ITriggerEventsJob
    {
        ...
        void ApplyDamage(Entity enemy, Entity projectile)
        {
            ...
            {
                var data = ProjectileDataLookup[projectile];
                ...
                // Só destrói se PierceCount não for -1 (Infinito)

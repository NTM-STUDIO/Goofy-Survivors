...
public class Movement : NetworkBehaviour 
{
    ...
    void FixedUpdate()
    {
        ...
        // Debug para verificar se está a tentar mover
        // Debug.Log($"[Movement] Input: {moveInput} | Speed: {playerStats.movementSpeed} | Velocity: {movementDirection * playerStats.movementSpeed * diagonalCompensation}");
